...
public class ParserConstants {
  ...
  public static final String ANDROID_NS_URL = "http://schemas.android.com/apk/res/android";
  public static final String ANDROID_NS_VALUE = "android";
  ...
  public static final int RES_TABLE_PACKAGE_TYPE = 0x0200; // 512
  public static final int RES_TABLE_TYPE_TYPE = 0x0201; // 513
  public static final int RES_TABLE_TYPE_SPEC_TYPE = 0x0202; // 514
  public static final int RES_TABLE_TYPE_LIBRARY = 0x0203; // 515
  public static final int RES_TABLE_TYPE_OVERLAY = 0x0204; // 516
  public static final int RES_TABLE_TYPE_OVERLAY_POLICY = 0x0205; // 517
  public static final int RES_TABLE_TYPE_STAGED_ALIAS = 0x0206; // 518
   ...
   * ResTable_map
   */
  public static final int ATTR_TYPE = makeResInternal(0);
  // For integral attributes, this is the minimum value it can hold.
  public static final int ATTR_MIN = makeResInternal(1);
  // For integral attributes, this is the maximum value it can hold.
  public static final int ATTR_MAX = makeResInternal(2);
  // Localization of this resource is can be encouraged or required with an aapt flag if this is set
  public static final int ATTR_L10N = makeResInternal(3);
  ...
  public static boolean isResInternalId(int resid) {
