...
public class RenameVisitor extends AbstractVisitor {
	...
	private void process(RootNode root) {
		...
		LoggerFactory.getLogger(RenameVisitor.class).debug("{} took {}", "UserRenames", System.currentTimeMillis() - before);
		before = System.currentTimeMillis();
		checkNames(root);
		LoggerFactory.getLogger(RenameVisitor.class).debug("{} took {}", "checkNames", System.currentTimeMillis() - before);
	}
